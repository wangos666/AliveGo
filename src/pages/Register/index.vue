  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <span class="error-msg" v-if="errorInfo">错误提示信息</span>
      </div>
      <div class="content">
        <label>验证码:</label>
      ...
      <div class="content">
        <label>确认密码:</label>
        <input type="password" placeholder="请输入确认密码" v-model="passwordComfirm">
        <span class="error-msg" v-if="errorInfo">错误提示信息</span>
      </div>
      <div class="controls">
        <input name="m1" type="checkbox" v-model="agree">
        <span>同意协议并注册《活力购用户协议》</span>
        <span class="error-msg" v-if="errorInfo">错误提示信息</span>
      </div>
      <div class="btn">
